      ...
      <div className="mx-auto flex flex-col gap-8 border-l border-zinc-300 p-6 text-sm font-medium">
        <p className="relative">
          ...
          <span className="text-zinc-600">
            ...
            04/05/2006 sob a liderança do pr. Marcos Granconato (Igreja Batista
            Redenção de São Paulo).
          </span>
        </p>
        <p className="relative">
          <span className="absolute inset-y-0 -left-8 my-auto h-4 w-4 rounded-full border border-zinc-400 bg-white" />
          ...
          <span className="text-zinc-600">
            ...
            Av. Lucas Nogueira Garcez, 4554. Poucos meses depois, buscou outro
            salão maior, na mesma avenida, no número 4497.
          </span>
        </p>
        <p className="relative">
          <span className="absolute inset-y-0 -left-8 my-auto h-4 w-4 rounded-full border border-zinc-400 bg-white" />
          ...
          <span className="text-zinc-600">
            ...
            pelo pr. Thomas Tronco dos Santos. Em 2013, a igreja mudou-se para a
            Rua Marco Vinicio Chiochetti, 339 e ali ficou até 2020. O pastor
            Thomas liderou a igreja até Maio de 2014.
          </span>
        </p>
        <p className="relative">
          <span className="absolute inset-y-0 -left-8 my-auto h-4 w-4 rounded-full border border-zinc-400 bg-white" />
        ...
        <p className="relative">
          ...
          <span className="text-zinc-600">
            ...
            Batista da Trindade, mantendo a mesma identidade teológica original.
          </span>
        </p>
        <p className="relative">
          <span className="absolute inset-y-0 -left-8 my-auto h-4 w-4 rounded-full border border-zinc-400 bg-white" />
          ...
          <span className="text-zinc-600">
            ...
            para prédio atual, que fica na rua Sueli Aparecida Leite Nogueira,
            569 - no bairro Ribeirão dos Porcos em Atibaia.
          </span>
        </p>
      </div>
    </section>
